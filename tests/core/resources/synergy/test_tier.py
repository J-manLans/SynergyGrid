...
def _tier_params(max_tier=10):
    return [
        (TierResource(t, (5, 5)), list(range(1, t))) for t in range(1, max_tier + 1)
    ]
...
class TestTier:
    ...
    def test_reaching_max_tier_breaks_tiers_list(self):
        ...
        max_tier_resource = TierResource(BaseTierResource.MAX_TIER, (5, 5))
